...
def compute_yesterday_ranking():
    ...
    if os.path.exists(ts_file):
        ...
        redis.Redis(unix_socket_path = config.get('redis','unix_socket'),\
...
if __name__ == '__main__':
    ...
    global_db           = redis.Redis(unix_socket_path = config.get('redis','unix_socket'),\
                                        db = config.get('redis','global'))
    history_db          = redis.Redis(unix_socket_path = config.get('redis','unix_socket_cache'),\
                                        db = config.get('redis','history'))
    history_db_static   = redis.Redis(unix_socket_path = config.get('redis','unix_socket'),\
                                        db = config.get('redis','history'))
